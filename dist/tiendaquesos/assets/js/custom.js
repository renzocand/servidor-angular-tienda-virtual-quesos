  ...
  $(function() {
    ...
    function product_tab() {
      $("#tabs li a").on("click", function(e) {
        ...
        $("#tabs .tab-" + title + ",#items .items-" + title).addClass(
          "selected"
        );
    ...
    function megamenu_tab() {
      $("#megatabs li a").on("click", function(e) {
        var title = $(e.currentTarget).attr("title");
        $("#megatabs li a , .tab_content #megaitems li div").removeClass(
          "selected"
        );
        $(
          "#megatabs .menu-tab-" + title + ",#megaitems .items-" + title
        ).addClass("selected");
