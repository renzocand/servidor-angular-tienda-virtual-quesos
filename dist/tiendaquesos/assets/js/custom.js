  ...
  $(function() {
    "use strict";
     ...
     $(document).on("ready", function() {
        price_range (); responsive_dropdown(); product_tab (); product_detail_tab (); megamenu_tab (); custom_tab (); scrolltop_arrow ();  countdown_clock(); slidebar_open(); option_drop();  location_page(); sidebar_margin(); detectmob(); grid_list_view();
     });
